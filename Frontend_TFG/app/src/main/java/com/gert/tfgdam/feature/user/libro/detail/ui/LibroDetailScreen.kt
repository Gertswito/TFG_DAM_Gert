package com.gert.tfgdam.feature.user.libro.detail.ui
...
import com.gert.tfgdam.ui.theme.estiloreutilizable.button.BotonAddListaDeseados
            ...
            item {
                if(libroEspecifico !== null) {
                    Column (
                        ...
                        BotonAddListaDeseados(
                            libroEspecifico, listaDeseadosViewModel.isLibroYaDeseado
                        )
